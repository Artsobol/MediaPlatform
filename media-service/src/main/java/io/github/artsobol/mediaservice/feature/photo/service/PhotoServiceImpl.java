...
public class PhotoServiceImpl implements PhotoService, PhotoFinder {
  ...
  public PhotoResponse create(PhotoCreateRequest photoCreateRequest, MultipartFile photoFile) {
    ...
    entity.updateBody(
        photoCreateRequest.title(),
        photoCreateRequest.description(),
        photoCreateRequest.photoDate());
    ...
    String originalImageKey =
        "photocards/%d/original/%s.%s".formatted(saved.getId(), UUID.randomUUID(), extension);
  ...
  public PhotoResponse updateBody(Long photoId, PhotoUpdateRequest photoUpdateRequest) {
    ...
    Photo entity = getByIdOrThrow(photoId);
    entity.updateBody(
        photoUpdateRequest.title(),
        photoUpdateRequest.description(),
        photoUpdateRequest.photoDate());
